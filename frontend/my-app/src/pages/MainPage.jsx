...
function MainPage() {
  ...
  useEffect(() => {
    ...
    axios
      .get("https://xn--hj2bu55bba230b7ub.xn--oi2b61z32a.xn--3e0b707e/main/monthlyStats?month=2024-11")
      .then((response) => {
  ...
  const fetchGames = (page) => {
    axios
      .get("https://xn--hj2bu55bba230b7ub.xn--oi2b61z32a.xn--3e0b707e/main/games")
      .then((response) => {
